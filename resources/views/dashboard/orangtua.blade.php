                ...
                <div class="absolute top-0 left-0 z-50 w-full pointer-events-none">
                    ...
                    @if(session('success'))
                        <div
                            ...
                            class="pointer-events-auto flex items-center p-3 text-white rounded-xl shadow-md bg-gradient-to-t from-[var(--primary-dark)] to-[var(--primary)] bg-opacity-80 backdrop-blur-sm">
                    ...
                    @if(session('error'))
                        <div
                            ...
                            x-transition:leave-start="opacity-100"
                            x-transition:leave-end="opacity-0 -translate-y-2"
                            class="pointer-events-auto flex items-center p-3 text-white rounded-xl shadow-md bg-gradient-to-t from-[var(--danger)] to-red-400 bg-opacity-80 backdrop-blur-sm">
            ...
            <div class="flex flex-col items-start justify-between gap-4 mb-4 sm:flex-row sm:items-center">
                <div>
                    ...
                    <p class="mt-1 font-medium text-body text-[var(--text-tertiary)]">
                        ...
                        @else
                            Yuk daftarkan anak Anda di TPA/DTA Al-Barokah sekarang juga!
                        @endif
                    </p>
                </div>
            </div>
                    ...
                    @foreach($students as $student)
                        <div class="px-5 py-3 bg-surface border border-custom border-l-4 shadow-sm rounded-2xl
                            ...
                            <div class="flex items-start justify-between gap-4">
                                ...
                                <div>
                                    ...
                                    @elseif($student->status == 'aktif')
                                        <span class="px-3 py-1 text-xs font-semibold rounded-full bg-[var(--success-light)] text-[var(--success)]">
                                            Aktif
                                        </span>
                                    @elseif($student->status == 'ditolak')
                                        <span class="px-3 py-1 text-xs font-semibold rounded-full bg-[var(--danger-light)] text-[var(--danger)]">
                                            Ditolak
                                        </span>
                                    @endif
                                </div>
                            ...
                            @if($student->status == 'ditolak')
                                <div class="p-3 mt-4 border rounded-xl border-[var(--danger-light)] bg-[var(--danger-light)]/30">
                            ...
                            <div>
                                ...
                                @else
                                    ...
                                    @if($student->status == 'nonaktif')
                                        <a href="#"
                                            class="block p-3 transition border rounded-xl bg-[var(--bg)] border-custom hover:border-[var(--primary)] hover:bg-[var(--primary-light)] hover:shadow-sm">
                                    @else
                                        <a href="{{ route('payments.index', ['student_id' => $student->id]) }}"
                                            class="block p-3 transition border rounded-xl bg-[var(--bg)] border-custom hover:border-[var(--primary)] hover:bg-[var(--primary-light)] hover:shadow-sm">
                                    @endif
                                        ...
                                        @else
                                            ...
                                            @if($sisaTagihan == 0)
                                                <div class="flex items-center gap-2 mt-2 text-xs text-[var(--success)]">
                                                    ...
                                                    <span>Semua iuran sudah lunas</span>
                                                </div>
                                            @endif
                                        @endif
