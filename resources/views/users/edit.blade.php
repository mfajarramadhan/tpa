                    ...
                    <div class="p-5 mt-8 border border-gray-100 rounded-2xl bg-gray-50">
                        ...
                        <div class="mb-4">
                            ...
                            <select name="school_grade"
                                ...
                                <option value="7 SMP"
                                    {{ old('school_grade', $user->student->school_grade) == '7 SMP' ? 'selected' : '' }}>
                                    7 SMP
                                </option>

                                <option value="8 SMP"
                                    {{ old('school_grade', $user->student->school_grade) == '8 SMP' ? 'selected' : '' }}>
                                    8 SMP
                                </option>

                                <option value="9 SMP"
                                    {{ old('school_grade', $user->student->school_grade) == '9 SMP' ? 'selected' : '' }}>
                                    9 SMP
                                </option>
